...
export const ACHIEVEMENTS = [
    ...
    { id: 'boss_slayer', name: 'Boss Slayer', desc: 'Land the last hit on a boss', color: '#c3a6ff',
        d: ['M14.5 3.5H20.5V9.5L10 20 4 14z', 'M7.5 12.5l4 4', 'M4 20l2.5-2.5'] },
    { id: 'survivor', name: 'Survivor', desc: 'Stay alive 30 minutes in one life', color: '#6ee0d6',
    ...
    { id: 'emerald_eye', name: 'Emerald Eye', desc: 'Pick up 25 emeralds', color: '#1fbf6b',
        d: ['M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z', 'M12 8.6 15 11.2 13.9 15H10.1L9 11.2z'] },
    { id: 'veteran', name: 'Veteran', desc: 'Play 250 lives', color: '#b4b8bd',
